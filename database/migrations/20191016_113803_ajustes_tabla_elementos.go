...
func (m *AjustesTablaElementos_20191016_113803) Down() {
	...
	m.SQL("ALTER TABLE catalogo.elemento ADD CONSTRAINT fk_elemento_tipo_bien FOREIGN KEY (tipo_bien_id)REFERENCES catalogo.tipo_bien (id) MATCH FULLON DELETE SET NULL ON UPDATE CASCADE;")

	m.SQL("ALTER TABLE catalogo.elemento ADD CONSTRAINT fk_elemento_subgrupo_catalogo FOREIGN KEY (subgrupo_catalogo_id)REFERENCES catalogo.subgrupo_catalogo (id) MATCH FULLON DELETE SET NULL ON UPDATE CASCADE;")
}
